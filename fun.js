...
telegram.onclick = ()=> {
  ...
  notificationBodyP.textContent = "https://flashbtc.rf.gd/chat"
}
...
function onloadFun() {
  let arr = ["[INFO] Flash BTC Transaction (Core Network)", "[INFO] Copyright (C) Flashbtc.rf.gd | JULY 2022. Telegram: https://flashbtc.rf.gd/chat", "[INFO] Running on", "[INFO] Blockchain network loading..."]
  let k = 0
  function onloadShow() {
